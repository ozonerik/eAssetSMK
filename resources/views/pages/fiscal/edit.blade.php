...
@endpush
@section('judul_hal','Edit Tahun Anggaran')
@section('header_hal')
        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card card-outline card-dark">
              ...
              <div class="card-body">
              <form method="POST" action="{{ route('fiscal.update', Crypt::encryptString($fiscalyear->id)) }}" autocomplete="off"  enctype="multipart/form-data">
                @csrf
                @hasanyrole('admin')
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      @php
                          $old_org = (old('_token') !== null) ? old('organitation') : $fiscalyear->organitation_id;            
                      @endphp
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="code" readonly required value="{{ old('code',$fiscalyear->code) }}"class="form-control @error('code') is-invalid @enderror" placeholder="Kode Tahun Anggaran ...">
                      @error('code')
                        <span class="invalid-feedback">{{ $message }}</span>
                      @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="year" required value="{{ old('year',$fiscalyear->year) }}"class="form-control @error('year') is-invalid @enderror" placeholder="Tahun Anggaran ...">
                      @error('year')
                        <span class="invalid-feedback">{{ $message }}</span>
                      @enderror
                    </div>
