            ...
            <div class="card card-outline card-dark">
              ...
              <form method="POST" action="{{ route('organitation.update', Crypt::encryptString($organitation->id)) }}" autocomplete="off"  enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="code" readonly required value="{{ old('code',$organitation->code) }}"class="form-control @error('code') is-invalid @enderror" placeholder="Kode Organisasi...">
                      @error('code')
